...
import styles from './LeaveTap.module.css'
...
export const LeaveTap: React.FC = () => {
        ...
        >
          ...
          >
            <Form.Item name="Type" label="请假类型" rules={[{ required: true }]}>
              <Select placeholder="请选择请假类型" allowClear>
            ...
            <Form.Item label="请假时长" name="timeLong">
            ...
            >
              <TextArea placeholder="请填写请假事由" rows={4} />
            </Form.Item>
              ...
              <div className={styles.DrawerBox}>
                ...
                <div className={styles.DrawerText}>
                  <div className={styles.DrawerTitle}>
                    <span style={{ marginRight: '10px' }}>张三的病假审批</span>
