...
import styles from './GoOutTap.module.css'
...
export const GoOutTap: React.FC = () => {
      ...
      <Tabs defaultActiveKey="1" onChange={callback}>
        ...
        >
          ...
          >
            ...
            >
              <TextArea placeholder="请填写外出事由" rows={4} />
            </Form.Item>
              ...
              <div className={styles.DrawerBox}>
                ...
                <div className={styles.DrawerText}>
                  <div className={styles.DrawerTitle}>
                    <span style={{ marginRight: '10px' }}>张三的外出审批</span>
