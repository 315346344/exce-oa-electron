...
import styles from './ReissueCardTap.module.css'
...
const data = [
  {
    key: '1',
    name: '张三',
    text: '测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试测试',
    type: '上班补卡',
    time: '2021-01-01',
    state: ['审批中'],
    car: '火车',
...
export const ReissueCardTap: React.FC = () => {
  ...
  return (
    <div className={styles.reissueCardTap}>
        ...
        >
          ...
          >
            ...
            <Form.Item
              label="补卡班次"
              name="type"
              rules={[{ required: true, message: '请选择补卡班次' }]}
            >
              <Select placeholder="请选择补卡班次" allowClear>
                <Option value="1">上班补卡</Option>
                <Option value="2">下班补卡</Option>
              </Select>
            </Form.Item>
            ...
            <Form.Item
              label="补卡事由"
              name="cause"
              rules={[{ required: true, message: '请填写补卡事由' }]}
            >
              <TextArea placeholder="请填写补卡事由" rows={4} />
            </Form.Item>
              ...
              <div className={styles.DrawerBox}>
                ...
                <div className={styles.DrawerText}>
                  <div className={styles.DrawerTitle}>
                    <span style={{ marginRight: '10px' }}>张三的补卡审批</span>
